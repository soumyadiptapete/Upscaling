% permeability upscaler in x-direction 2x2x6
ny_226=110;
nx_226=30;
nz_226=15;
kx_new=zeros(ny_226,nx_226,nz_226);
...
for k1=1:nz_d
 ...
 kx_new(floor(i/2)+1,floor(j/2)+1,floor(k/6)+1)= q_d*nx_d*20/(ny_d*10*nz_d*2*0.00633);
        end
    end
end
...
Tx_226_perm=zeros(ny_226,nx_226+1,nz_226);
% side t=0
for k=1:nz_226
    for i=1:ny_226
        j=1;
