%z diretion 4*4*6 upscaling
ny_446=55;
nx_446=15;
nz_446=15;
kz_new=zeros(ny_446,nx_446,nz_446);
...
for k1=1:nz_d
 ...
 kz_new(floor(i/4)+1,floor(j/4)+1,floor(k/6)+1)= q_d*nz_d*2/(nx_d*20*ny_d*10*0.00633);
        end
    end
end
...
Tz_446_perm=zeros(ny_446,nx_446,nz_446+1);
%top T=0;
for i=1:ny_446
    for j=1:nx_446
        k=1;
