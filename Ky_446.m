% permeability upscaler in y-direction 4x4x6

ny_446=55;
nx_446=15;
nz_446=15;
ky_new=zeros(ny_446,nx_446,nz_446);
...
for k1=1:nz_d
 ...
 ky_new(floor(i/4)+1,floor(j/4)+1,floor(k/6)+1)= q_d*ny_d*10/(nx_d*20*nz_d*2*0.00633);
        end
    end
end
...
Ty_446_perm=zeros(ny_446+1,nx_446,nz_446);
%side T=0;
for k=1:nz_446
    for j=1:nx_446
        i=1;
